...
def delete_index_tree(tree, schemaDict=None, key=None):   #haven't finish
    #csv file do not involve delete, just index tree
    #consider how to deal with foreign key
    #cascade, set null, restrict
    #parser: delete
    #two mode: given (tree & schemaDict) or given (tree & primary key)
    ...
    #tree & schemaDict: schemaDict與很像(有where clause --> 'where': {'conditions': ['name LIKE ‘W%’', 'p# BETWEEN 11 AND 15', 'a_num BETWEEN 20 AND 25', 'p# IN (2,4,8)'] and "=, >, <, >=, <=, !="})  --> 查SQL delete
    #tree & primary key: 正在drop table
    pass
